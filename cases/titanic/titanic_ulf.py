...
def generate_random_forest_model(dados):
    """
    Generate the Random Forest model for dados

    Parameters
    ----------
    dados : DataFrame with data 


    Returns
    -------
    rf_grid_model : created model
...
# =============================================================================
# Escolha dos modelos a serem utilizados: ver https://scikit-learn.org/stable/tutorial/machine_learning_map/index.html
#     Objetivo: Classificação
#     Variavel: Survived - binária
#     Modelos a serem analisados: Random Forest / Linear SVC / TreeDecision
#       parametros: supervisionado / amostra com 890 registros /  
# =============================================================================

clf_rf = generate_random_forest_model(df_treino)
